...
<template>
  <div class="grid grid-cols-5 grid-rows-8 gap-5">
    ...
    />
    <div class="bg-base-300 col-span-3 row-span-4 row-start-5 rounded-xl"></div>
    <div class="bg-base-300 col-span-2 col-start-4 row-span-4 row-start-5 rounded-xl"></div>
  </div>
</template>
